...
public class Coin {
    ...
    public boolean equals(Coin aCoin) { 
        if(aCoin.myValue == 0.25 && aCoin.myName == "quarter"){
            return true;
        }
        if(aCoin.myValue == 0.01 && aCoin.myName == "penny"){
            return true;
        }
        if(aCoin.myValue == 0.05 && aCoin.myName == "nickel"){
            return true;
        }
        if(aCoin.myValue == 0.1 && aCoin.myName == "dime"){
            return true;
        }
        if(aCoin.myValue == 0.5 && aCoin.myName == "half dollar"){
            return true;
        }
        if(aCoin.myValue == 1 && aCoin.myName == "dollar coin"){
            return true;
        }
